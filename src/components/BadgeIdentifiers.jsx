import { HTML, CSS, JS, PHP, SQL, DJANGO, REACT, NODE, TS, GRAPHQL, MONGODB, EXPRESS, TAILWINDCSS, FIREBASE, FLASK, PYTORCH, PYTHON, OPENCV, JAVA } from './svg/badges';
...
const badgeData = [
    ...
    { id: 'java', label: 'Java', Component: JAVA },
